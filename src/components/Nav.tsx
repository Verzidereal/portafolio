    ...
    <header className="sticky top-0 z-50 backdrop-blur bg-bg/70 border-b border-white/5">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        <a href="/" className="flex items-center gap-3">
          <img src="/assets/img/avatar.svg" alt="Logo Verzide" className="w-8 h-8" />
        ...
        {/* Hamburger (mobile) */}
        <button
          className="md:hidden inline-flex items-center justify-center rounded-lg p-2 hover:bg-white/5 focus:outline-none focus:ring-2 focus:ring-accent/60"
      ...
      <div
        id="mobile-menu"
        className={`md:hidden border-t border-white/5 ${open ? "block" : "hidden"}`}
      >
